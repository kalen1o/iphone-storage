      ...
      >
        <div>
          ...
          <p className="mt-4 text-base text-foreground/80">
            Scroll here to auto-play the preview (muted). When it ends, the player grows for a
            closer look—hover the video to reveal a replay button, or scroll away and back to play
            again.
          </p>
        </div>
